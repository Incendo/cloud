...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bukkit:1.8.2'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bungee:1.8.2'
}
```
...
```groovy
dependencies {
    modImplementation 'cloud.commandframework:cloud-fabric:1.8.2'
}
```
