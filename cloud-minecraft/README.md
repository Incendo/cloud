...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bukkit:1.2.0'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bungee:1.2.0'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-velocity:1.2.0'
}
```
