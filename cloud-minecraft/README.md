...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bukkit:1.8.3-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-paper:1.8.3-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bungee:1.8.3-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-velocity:1.8.3-SNAPSHOT'
}
```
...
```groovy
dependencies {
    modImplementation 'cloud.commandframework:cloud-fabric:1.8.3-SNAPSHOT'
}
```
