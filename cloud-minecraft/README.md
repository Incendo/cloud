...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bukkit:1.2.0-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-paper:1.2.0-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bungee:1.2.0-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-velocity:1.2.0-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-cloudburst:1.2.0-SNAPSHOT'
}
```
...
```groovy
dependencies {
    modImplementation 'cloud.commandframework:cloud-fabric:1.2.0-SNAPSHOT'
}
```
...
[ServerCommandSource](https://ci.nukkitx.com/job/NukkitX/job/Nukkit/job/master/javadoc/cn/nukkit/command/CommandSender.html), 
