...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bukkit:1.6.2-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-paper:1.6.2-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-bungee:1.6.2-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'cloud.commandframework:cloud-velocity:1.6.2-SNAPSHOT'
}
```
...
```groovy
dependencies {
    modImplementation 'cloud.commandframework:cloud-fabric:1.6.2-SNAPSHOT'
}
```
